...
public class terminal_222Activity extends AppCompatActivity implements View.OnClickListener{
    private TextView mDatePicker;
    private DatePickerDialog.OnDateSetListener mDateSetLinster;
    private static final String TAG="terminal_222Activity";
    private Button button_page222_2,button_page222_3;
    private DBOpenHelper dbOpenHelper=new DBOpenHelper(this);
    private String time,type,mark,money;
    private EditText editText_page222_1,editText_page222_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page222);
        button_page222_2=(Button)findViewById(R.id.button_page222_2);
        button_page222_3=(Button)findViewById(R.id.button_page222_3);
        button_page222_3.setOnClickListener(this);
        button_page222_2.setOnClickListener(this);
        Spinner=(Spinner)findViewById(R.id.Spinner);
        editText_page222_1=(EditText)findViewById(R.id.editText_page222_1);
        editText_page222_2=(EditText)findViewById(R.id.editText_page222_2);
        mDatePicker= (TextView) findViewById(R.id.button_page222_1);
        //取bundle
        try{
            Intent intent = getIntent();
            Bundle bundle= intent.getExtras();
            inaccountInfo=(inaccountInfo)bundle.get("inaccountInfo");
            editText_page222_1.setText(String.valueOf(inaccountInfo.getMoney()));
            ...
            editText_page222_2.setText(inaccountInfo.getMark());
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button_page222_2:
                time=mDatePicker.getText().toString();
                money=editText_page222_1.getText().toString();
                mark=editText_page222_2.getText().toString();
